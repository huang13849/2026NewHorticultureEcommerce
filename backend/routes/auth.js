...
// ============================================================================
// /auth/profile & /auth/address — user_profile-service (Mongo)
// Auth: prefers sid HttpOnly cookie (login-service). Falls back to legacy Bearer.
// ============================================================================
...
router.get('/profile', async (req, res) => {
  ...
  try {
    ...
    console.error('[GET /auth/profile]', e.message);
    res.status(500).json({ error: 'db_error', detail: e.message });
  }
});

// PATCH /auth/profile — update nickname/phone/email/gender/tags/preferences/avatar
router.patch('/profile', async (req, res) => {
  ...
  try {
    ...
    console.error('[PATCH /auth/profile]', e.message);
    res.status(e.message === 'profile_not_found' ? 404 : 500).json({ error: e.message });
  }
});

// GET /auth/address — list addresses
...
// PUT /auth/address — upsert one address; if isDefault, others cleared
...
// POST /auth/address/:id/default — set default
