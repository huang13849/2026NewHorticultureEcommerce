    ...
    <div className="min-h-screen bg-stone-50/40 text-stone-900">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-10 grid lg:grid-cols-[1.4fr_1fr] gap-4">
        ...
        <div className="rounded-2xl bg-white border border-stone-200 p-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {p.sameStyle.map((s) => (
              <Link key={s.id} href={`/product/${id}`} className="rounded-xl border border-stone-200 p-3 text-center hover:border-stone-400 transition-colors">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-12">
        ...
        <div className="mt-4 grid sm:grid-cols-3 gap-4">
          {p.aiAlsoLike.map((a) => (
            <Link key={a.id} href={`/product/${id}`} className="rounded-2xl bg-white border border-stone-200 overflow-hidden hover:shadow-md transition-shadow">
